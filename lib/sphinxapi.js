...
SphinxClient.prototype.RunQueries = function (fn) {
  ...
  debug.client('>HHLLL', [SphinxClient.SEARCHD_COMMAND_SEARCH, SphinxClient.VER_COMMAND_SEARCH, length, 0, nreqs]);
...
SphinxClient.prototype.Status = function (fn) {
  var self = this
  debug.client('>2HLL', [SphinxClient.SEARCHD_COMMAND_STATUS, SphinxClient.VER_COMMAND_STATUS, 4, 1]);
